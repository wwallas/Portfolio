...
<html>
  ...
  <body>
    ...
    <section id="intro" style="background: url(img/home.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        ...
        <h1 data-animate="fadeInDown" class="text-shadow mb-5">William Alfonso</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div data-animate="fadeInUp" class="col-lg-6">
            <p>With more than 2 years of experience, I have developed strong professional skills as a software developer as well as an IT analyst. My background includes an in-depth understanding of developing software, systems test, fixing bugs and participating in the design of solutions to business problems as well as producing as-built systems documents. I bring strong innovative solutions and thinking to every project. In addition to this professional experience, my degree in computer science engineering has proven to be of value in the roles I have occupied. As you can see, this unique combination of practical and theoretical experience would make me a valuable addition to you team.</p>
          ...
          <div data-animate="fadeInUp" class="col-sm-6 mx-auto mt-5"><img src="img/Festival.jpg" alt="This is me - IT worker" class="image rounded-circle img-fluid"></div>
        </div>
      </div>
    </section>
    <!-- Service-->
          ...
          <div id="references-masonry" data-animate="fadeInUp">
            <div class="row">
                  <div data-category="webdesign" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="img/okotoks-pizza-logo.png" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                            <h3 class="h4 reference-title">Okotoks Pizza</h3>
                  ...
                  <div data-category="webdesign" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="img/GBM.PNG" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                            <h3 class="h4 reference-title">Game Battle Monster</h3>
                            <p>Short project description goes here...</p>
                          </div>
                        </div></a>
                  ...
                  <div data-category="webdesign" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="img/RPS.PNG" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                            <h3 class="h4 reference-title">Rock, Paper, Scissors </h3>
                            <p>Short project description goes here...</p>
                          </div>
                        </div></a>
                      <!-- <div data-images="img/main-slider1.jpg,img/main-slider2.jpg,img/main-slider3.jpg" class="sr-only reference-description">
                  ...
                  <div data-category="webdesign" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="img/tweeter.png" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                            <h3 class="h4 reference-title">Tweeter</h3>
                            <p>Short project description goes here...</p>
                          </div>
                        </div></a>
                      <!-- <div data-images="img/main-slider1.jpg,img/main-slider2.jpg,img/main-slider3.jpg" class="sr-only reference-description">
  ...
  <div class="row">
    ...
    <script src="assets/jquery.counterup/jquery.counterup.js"></script>
